...
class HTMLCanvasElement extends Element {
  constructor(token, nid) {
    if (token !== _canvasElementToken) _graphicsIllegalConstructor();
    super(nid);
...
_graphicsTag(HTMLCanvasElement.prototype, 'HTMLCanvasElement');
globalThis.HTMLCanvasElement = HTMLCanvasElement;
const _oldConstructElement = _constructElement;
_constructElement = function(C, nid) { return C === HTMLCanvasElement ? new C(_canvasElementToken, nid) : _oldConstructElement(C, nid); };
...
for (const pair of [[HTMLCanvasElement,'HTMLCanvasElement'],[OffscreenCanvas,'OffscreenCanvas'],[CanvasRenderingContext2D,'CanvasRenderingContext2D'],[ImageBitmap,'ImageBitmap']]) _markNative(pair[0]);
for (const pair of [[HTMLCanvasElement.prototype,'getContext',2],[HTMLCanvasElement.prototype,'toDataURL',0],[HTMLCanvasElement.prototype,'toBlob',1],[HTMLCanvasElement.prototype,'transferControlToOffscreen',0],[OffscreenCanvas.prototype,'getContext',2],[OffscreenCanvas.prototype,'convertToBlob',0],[OffscreenCanvas.prototype,'transferToImageBitmap',0],[ImageBitmap.prototype,'close',0]]) {
  const fn = pair[0][pair[1]]; if (typeof fn === 'function') _graphicsDefineMethod(pair[0], pair[1], pair[2], fn);
}
for (const pair of [[HTMLCanvasElement.prototype,'width'],[HTMLCanvasElement.prototype,'height'],[OffscreenCanvas.prototype,'width'],[OffscreenCanvas.prototype,'height']]) {
